...
@section('page-subtitle', 'Daftar seluruh surat keluar')

@section('content')
<div class="fade-in-up">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <p class="text-gray-500 text-sm">Total: <strong class="text-gray-900">{{ $surats->total() }}</strong> surat keluar</p>
    ...
    <div class="card p-5 mb-5">
        <form action="{{ route('surat.keluar') }}" method="GET" class="flex flex-wrap gap-3 items-end">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('surat.keluar') }}" class="btn-secondary">
    ...
    <div class="card overflow-hidden">
        ...
        <div class="text-center py-16">
            <span class="material-symbols-outlined text-6xl text-gray-200">send</span>
            <h3 class="font-heading font-semibold text-gray-500 mt-3">Tidak ada surat keluar</h3>
            <p class="text-sm text-gray-400 mt-1">Belum ada surat keluar yang ditambahkan.</p>
            ...
            <table class="data-table w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="font-mono text-xs font-semibold bg-purple-50 text-purple-800 px-2.5 py-1 rounded-lg">{{ $surat->kode_surat }}</span>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="flex items-center gap-2">
                                <div class="w-7 h-7 rounded-full bg-navy-900 flex items-center justify-center text-white text-xs font-bold font-heading" style="background: #002147">
        ...
        <div class="px-6 py-4 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-1">
                ...
                @else
                <a href="{{ $surats->previousPageUrl() }}" class="px-3 py-1.5 rounded-lg text-sm text-gray-600 border border-gray-200 hover:bg-gray-50">‹</a>
                @endif
                ...
                <a href="{{ $surats->nextPageUrl() }}" class="px-3 py-1.5 rounded-lg text-sm text-gray-600 border border-gray-200 hover:bg-gray-50">›</a>
                @else
                <span class="px-3 py-1.5 rounded-lg text-sm text-gray-300 border border-gray-100">›</span>
                @endif
            </div>
